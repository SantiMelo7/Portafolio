...
export const GitHub = () => {
    ...
    return (
        ...
        <svg width="29" height="50" fill="currentColor" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 250">
...
export function Linkedin(){
    ...
    return (
        ...
        <svg width="25" height="50" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256">
