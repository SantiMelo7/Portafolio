...
export const HTML = () => {
  return (
    <>
      <Image src={HtmlImg} width={60} alt="HTML" />
...
export const CssSvg = () => {
  return (
    <>
      <Image src={CssImg} width={60} alt="CSS" />
...
export const Javascript = () => {
  return (
    <>
      <Image src={JavascriptImg} width={60} alt="JAVASCRIPT" />
...
export const ReactJs = () => {
  return (
    <>
      <Image src={ReactImg} width={60} alt="REACT JS" />
...
export const NextJs = () => {
  return (
    <>
      <Image src={NextImg} width={60} alt="NEXT JS" />
...
export const MongoDB = () => {
  return (
    <>
      <Image src={MongoImg} width={60} alt="MONGO DB" />
...
export const Postman = () => {
  return (
    <>
      <Image src={PostmanImg} width={60} alt="POSTMAN" />
...
export const GitHubSvg = () => {
  return (
    <>
      <Image src={GitHubImg} width={60} alt="GITHUB" />
...
export const Git = () => {
  return (
    <>
      <Image src={GitImg} width={60} alt="GIT" />
...
export const MaterialUi = () => {
  return (
    <>
      <Image src={MaterialUiImg} width={60} alt="MATERIAL UI" />
...
export const Talwind = () => {
  return (
    <>
      <Image src={TalwindImg} width={60} alt="TALWIND" />
...
export const Axios = () => {
  return (
    <>
      <Image src={AxiosImg} width={60} alt="Axios" />
...
export const StyledComponents = () => {
  return (
    <>
      <Image src={StylesComponentsImg} width={60} alt="StyleD-Components" />
...
export const Vite = () => {
  return (
    <>
      <Image src={ViteImg} width={60} alt="VITE" />
