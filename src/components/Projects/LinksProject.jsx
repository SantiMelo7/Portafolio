  ...
  return (
    <>
      <Links
        ...
        text-xl text-yellow-200 py-1 transition md:hover:scale-95 md:gap-x-8 md:mt-1
        sm:px-12 sm:gap-x-4 sm:mt-4 sm:hover:scale-95 sm:w-[180px] md:w-[210px] ${className}`}
        text={text}
      >
        {children}
      </Links>
