...
export default function LinkProject({ text, className, children }) {
  return (
    <>
      <Links
        className={`border-[2.5px] dark:border-[1.7px] border-amber-900 dark:border-yellow-500
        ...
        sm:px-12 sm:gap-x-4 sm:mt-4 sm:hover:scale-95 w-96 dark:bg-transparent bg-slate-100 ${className}`}
        text={text}
      >
        {children}
      </Links>
