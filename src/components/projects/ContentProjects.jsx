      ...
      <section className="scroll-m-20 w-full mt-10 xl:p-0 p-4 mx-auto container lg:max-w-6xl md:max-w-4xl">
        ...
        <div className="flex flex-col gap-y-16">
          {data.map((project) => (
            ...
            >
              {project.disabled && (
                <div className="absolute inset-0 bg-black/40 md:translate-x-8 -translate-y-[6px] w-full h-full flex items-start justify-start z-10 group-hover:opacity-0 transition-opacity duration-300">
